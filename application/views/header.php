...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>plugins/dist/css/en/skins/skin-purple.css">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
          ...
          <span class="logo-mini"><b>GSD</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Get Shit Done</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php echo $this->ion_auth->user()->row()->first_name;
                                                echo ' ';
